                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="lp-field">
                            ...
                            <div class="lp-inp-wrap">
                                ...
                                <input id="lp_email" type="email" name="email" class="lp-inp @error('email') lp-inp--err @enderror" value="{{ old('email', Cookie::get('saved_email')) }}" placeholder="Enter your email address" required autocomplete="email" autofocus>
                            </div>
                            @error('email')
                        ...
                        <div class="lp-field">
                            ...
                            <div class="lp-inp-wrap">
                                ...
                                <input id="lp_password" type="password" name="password" class="lp-inp @error('password') lp-inp--err @enderror" value="{{ Cookie::get('saved_password') }}" placeholder="Enter your password" required autocomplete="current-password">
