...
<div class="sidebar">
    ...
    <ul>
        <li class="{{ (isset($activePageId) && $activePageId === 'property-management') ? 'active' : '' }}" data-page-target="property-management">
            <i class="bi bi-building"></i>
            <span>Property Management</span>
        </li>
        <li class="{{ (isset($activePageId) && $activePageId === 'budget-management') ? 'active' : '' }}" data-page-target="budget-management">
            <i class="bi bi-cash-coin"></i>
            <span>Budget Management</span>
        </li>
        <li class="{{ (isset($activePageId) && $activePageId === 'property-transfer') ? 'active' : '' }}" data-page-target="property-transfer">
            <i class="bi bi-send-plus-fill"></i>
            <span>Property Transfer</span>
        </li>
        <li class="{{ (isset($activePageId) && $activePageId === 'waste-disposal') ? 'active' : '' }}" data-page-target="waste-disposal">
    ...
    {{--  FOOTER --}}
    <div style=" margin-top: auto; padding: 14px 16px; border-top: 1px solid rgba(255,255,255,0.1); text-align: center; color: rgba(255,255,255,0.5); font-size: 0.68rem; line-height: 1.6; ">
        <small>
